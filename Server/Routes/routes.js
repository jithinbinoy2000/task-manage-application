...
const taskController = require('../Controllers/taskController')
 ...
 router.delete('/delete-project/:id',verifyMiddleware.verifyMiddleware,projectController.deleteProject)
 ...
 router.delete('/delete-task/:pid/:tid',verifyMiddleware.verifyMiddleware,taskController.deleteTask)
 router.get('/delete-task/:pid',verifyMiddleware.verifyMiddleware,taskController.getAllTask)
